...
class ChSelectPolePage extends StatefulWidget {
  ChSelectPolePage(this.auth, this.chuden, this.event);
  ...
  @override
  _ChSelectPolePageState createState() => _ChSelectPolePageState();
}


class _ChSelectPolePageState extends State<ChSelectPolePage> {
  ...
  void initState() {
    ...
    // 電柱の名前を初期化
    if (widget.chuden.pole != null) {
      _poleName = widget.chuden.pole.name;
                      ...
                      children: <Widget>[
                        ...
                        showPoleSearchButton(
                            ...
                            _poleName != null ? Colors.black : Colors.grey, () {
                              ...
                              showPolePicker(context, widget.chuden.office.characterList,
                              _selected, _selectPole);
                            }),
                        addPadding(3),
  ...
  void _eventSubmit() {
    ...
    getPole(widget.chuden.office.branch.name, widget.chuden.office.name, _poleName)
        .then((pole) {
          ...
          Navigator.pop(context);
          setBeforePage(belongToCh, ChNavigationMenuItem.event.index, ChEventAddPath);

...
class ChEventDetailPage extends StatefulWidget {
  ChEventDetailPage(this.auth, this.chuden, this.event);
  ...
  @override
  _ChEventDetailPageState createState() => _ChEventDetailPageState();
}

class _ChEventDetailPageState extends State<ChEventDetailPage> {
  ...
  void initState() {
    ...
    setBeforePage(5, ChNavigationMenuItem.event.index, ChEventDetailPath);

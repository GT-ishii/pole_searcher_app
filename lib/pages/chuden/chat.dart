...
class ChChatPage extends StatefulWidget {
  ChChatPage(this.auth, this.chuden);
  final Auth auth;
  final Chuden chuden;

  @override
  _ChChatPageState createState() => _ChChatPageState();
}

class _ChChatPageState extends State<ChChatPage> {
  ...
  void initState(){
    ...
    _inputMessage = '';
    setBeforePage(belongToCh, ChNavigationMenuItem.chat.index, ChChatPath);

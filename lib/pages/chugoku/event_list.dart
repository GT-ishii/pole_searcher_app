...
class CgEventListPage extends StatefulWidget {
  CgEventListPage(this.auth, this.chugoku, this.event);
  ...
  @override
  _CgEventListPageState createState() => _CgEventListPageState();
}

class _CgEventListPageState extends State<CgEventListPage> {
  ...
  void initState() {
    ...
    widget.auth.getUser()
      ...
      getEventsChugoku(_user, widget.chugoku).then((eventList) {
        setState(() {
  ...
  Future<void> _refleshList() async{
    ...
    await getEventsChugoku(_user, widget.chugoku).then((eventlist) {
      setState(() {
        _eventList = List.from(eventlist);
        _searchList = List.from(eventlist);
      });
  ...
  Future<void> _goNext(int index) async{
    ...
    await Navigator.pushNamed(context, CgEventDetailPath)
        .whenComplete(() async{
      showProgressIndicator(context);
      await _refleshList()

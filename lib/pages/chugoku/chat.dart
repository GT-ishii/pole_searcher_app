...
class CgChatPage extends StatefulWidget {
  CgChatPage(this.auth, this.chugoku);
  final Auth auth;
  final Chugoku chugoku;

  @override
  _CgChatPageState createState() => _CgChatPageState();
}

class _CgChatPageState extends State<CgChatPage> {
  ...
  void initState(){
    ...
    _inputMessage = '';
    setBeforePage(belongToCg, CgNavigationMenuItem.chat.index, CgChatPath);

...
class CgEventDetailWorkPage extends StatefulWidget {
  CgEventDetailWorkPage(this.auth, this.chugoku, this.event);
  ...
  @override
  _CgEventDetailWorkPageState createState() => _CgEventDetailWorkPageState();
}

class _CgEventDetailWorkPageState extends State<CgEventDetailWorkPage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToCg, CgNavigationMenuItem.event.index, CgEventDetailWorkPath);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
          Navigator.popUntil(context, ModalRoute.withName(CgEventListWorkPath));

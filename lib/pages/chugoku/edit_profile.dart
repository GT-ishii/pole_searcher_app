...
class CgEditProfilePage extends StatefulWidget {
  CgEditProfilePage(this.chugoku, this.auth);

  final Chugoku chugoku;
  final Auth auth;

  @override
  _ThEditProfilePageState createState() => _ThEditProfilePageState();
}

class _ThEditProfilePageState extends State<CgEditProfilePage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToCg, CgNavigationMenuItem.setting.index, CgEditProfilePath);
      ...
      body: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                addPadding(2),
                showPasswordChange('現在のパスワード', FocusNode(), _hideOld, _cbOldPw, _cbHideOldPw),
                showPasswordChange('新しいパスワード', FocusNode(), _hideNew, _cbNewPw, _cbHideNewPw),
                addPadding(1),
                showSubmit(_formKey, '変更', const Size(210,50), 22, Colors.indigo, _canSubmit ? _chPw : null),
              ],
            ),
          )),

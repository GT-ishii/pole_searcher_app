...
class CgEventUpdatePage extends StatefulWidget {
  CgEventUpdatePage(this.auth, this.chugoku, this.event);
  ...
  @override
  _CgEventUpdatePageState createState() => _CgEventUpdatePageState();
}

class _CgEventUpdatePageState extends State<CgEventUpdatePage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToCg, CgNavigationMenuItem.event.index, CgEventUpdatePath);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: () async {
          Navigator.popUntil(context, ModalRoute.withName(CgEventDetailPath));
                      ...
                      child: SizedBox(
                        child: TextFormField(
                          ...
                          onTap: () {
                            ...
                            Navigator.pushNamed(context, CgEventPolePath).then((eventPole){
                              setState(() {
                                setBeforePage(belongToCg, CgNavigationMenuItem.event.index, CgEventUpdatePath);
                                if(eventPole != null) {
  ...
  Future<void> _upload() async{
    ...
    try {
      ...
      updateEvent(_user, widget.chugoku, _updateData);

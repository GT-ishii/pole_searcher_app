...
class CgEventDetailPage extends StatefulWidget {
  CgEventDetailPage(this.auth, this.chugoku, this.event);
  ...
  @override
  _CgEventDetailPageState createState() => _CgEventDetailPageState();
}

class _CgEventDetailPageState extends State<CgEventDetailPage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToCg, CgNavigationMenuItem.event.index, CgEventDetailPath);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
          ...
          setBeforePage(belongToCg, CgNavigationMenuItem.event.index, CgEventListPath);
                        ...
                        Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                addPadding(1),
                                showSubmit(_formKey, '作業追加', const Size(125, 50), 18, Colors.indigo, _cbWork),
                              ],
                            )
                        ),
      ...
      list.add(showCheckBox(statusList[i], _status[i], (value){
        setState(() {
          if (_oldIndex != i) {
            ...
            _status[i] = true;
            updateEventStatusChugoku(_user, widget.chugoku, widget.event.data.id, statusList[i]);
  ...
  void _cbDelete(){
    ...
    showPopupConfirm(
        '削除しますか？', context,
          ...
          deleteEvent(_user, widget.chugoku, widget.event.data.id);
  ...
  void _cbWork(){
    ...
    setEventWorkerChugoku(_user, widget.chugoku, widget.event.data.id);

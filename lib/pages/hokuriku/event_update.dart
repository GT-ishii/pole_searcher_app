...
class HrEventUpdatePage extends StatefulWidget {
  HrEventUpdatePage(this.auth, this.hokuriku, this.event);
  ...
  @override
  _HrEventUpdatePageState createState() => _HrEventUpdatePageState();
}

class _HrEventUpdatePageState extends State<HrEventUpdatePage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToHr, HrNavigationMenuItem.event.index, HrEventUpdatePath);
    ...
    setState(() {
      ...
      if (_updateData.eventPole != null){
        _poleController.text = '${_updateData.eventPole['area']}  ${_updateData.eventPole['pole']}';
      }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.popUntil(context, ModalRoute.withName(HrEventDetailPath));
                      ...
                      child: SizedBox(
                        child: TextFormField(
                          ...
                          onTap: () {
                            ...
                            Navigator.pushNamed(context, HrEventPolePath).then((eventPole){
                              setState(() {
                                setBeforePage(belongToHr, HrNavigationMenuItem.event.index, HrEventUpdatePath);
                                if(eventPole != null) {
  ...
  Future<void> _upload() async{
    ...
    try {
     ...
     final url = await setEventImage(_imageFile);
      ...
      updateEvent(_user, widget.hokuriku, HokurikuID, _updateData);

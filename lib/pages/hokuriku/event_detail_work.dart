...
class HrEventDetailWorkPage extends StatefulWidget {
  HrEventDetailWorkPage(this.auth, this.hokuriku, this.event);
  ...
  @override
  _HrEventDetailWorkPageState createState() => _HrEventDetailWorkPageState();
}

class _HrEventDetailWorkPageState extends State<HrEventDetailWorkPage> {
  ...
  void initState() {
    ...
    setBeforePage(belongToHr, HrNavigationMenuItem.event.index, HrEventDetailWorkPath);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.popUntil(context, ModalRoute.withName(HrEventListWorkPath));

...
import 'package:polesearcherapp/models/tohoku/event.dart';
  ...
  Future<void> callback(Geolocation value) async {
    ...
    if (data != null) {
      ...
      if (data.eventPole != null) {
        final line = data.eventPole['line'] as String;
        final pole = data.eventPole['pole'] as String;
        title =  '$line / $pole';
      }
    }
    ...
    flutterLocalNotificationsPlugin.show(
        DateTime.now().millisecond.toInt(), '種別: $type', '電柱: $title', platformChannelSpecifics,
        payload: 'item x');
